        ...
        <section className="relative py-20 lg:py-28 bg-primary overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-primary-foreground/60 font-body text-base md:text-lg leading-relaxed max-w-xl mx-auto mb-8">
                {packages.length} pacotes exclusivos — de Páscoa a Réveillon. 
                Pensão completa e crianças até 6 anos grátis.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-primary-foreground/5 rounded-xl p-4 border border-primary-foreground/10 max-w-3xl mx-auto"
            >
              <DateSearchBar />
            </motion.div>
          ...
          <div className="container mx-auto px-4 py-8 lg:py-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-muted-foreground font-body text-xs">Café, almoço e jantar inclusos</p>
              </div>
            </div>
          </div>
        </section>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
                    ...
                    <div className="md:col-span-4 relative overflow-hidden h-48 md:h-auto">
                      ...
                      <span className={`absolute top-3 left-3 ${pkg.tagColor} text-primary-foreground text-[9px] font-body uppercase tracking-wider px-2.5 py-1 rounded-full`}>
                        {pkg.tag}
                      </span>
                    </div>

                    {/* Content */}
                    <div className="md:col-span-5 p-5 md:p-6 flex flex-col justify-center">
                      <h3 className="font-display text-xl font-semibold text-foreground mb-1.5">{pkg.shortTitle}</h3>
                      ...
                      <p className="text-muted-foreground font-body text-sm leading-relaxed mb-3 line-clamp-2">
                        {pkg.description}
                      </p>
                    ...
                    {/* Price + CTA */}
                    <div className="md:col-span-3 p-5 md:p-6 bg-hotel-cream/50 flex flex-col justify-center border-t md:border-t-0 md:border-l border-border">
