        ...
        <section className="py-24 lg:py-36 bg-background">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 max-w-6xl mx-auto items-center">
              ...
              >
                <img <img src="/images/sobre-vista-pedra.jpg" alt="Vista panorâmica da fazenda com Pedra do Cônego" className="w-full h-[500px] object-cover" loading="lazy" /> alt="Vista panorâmica da fazenda" className="w-full h-[500px] object-cover" loading="lazy" />
              </motion.div>
            </div>
          </div>
        </section>
