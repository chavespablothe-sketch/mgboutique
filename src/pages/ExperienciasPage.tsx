...
const experiences = [
  { icon: Flower2, title: "Spa & Bem-estar", description: "Massagens relaxantes ao ar livre, sauna seca e tratamentos corporais com produtos naturais da serra. Permita que sua essência se reconecte com a tranquilidade absoluta.", image: "https://www.minhagloria.com.br/lovable-uploads/04460747-2a8e-4012-a6be-1b1819ad5997.png", audience: "Casais" },
  ...
  { icon: Mountain, title: "Quadriciclo", description: "Adrenalina com paisagem de cinema pelas trilhas da fazenda. Experiências de 30 ou 60 minutos. Aventura segura para adultos e adolescentes.", image: "https://www.minhagloria.com.br/lovable-uploads/57dfbded-962a-4f7c-ba13-7710e31700e4.png", audience: "Aventura" },
  ...
  { icon: Waves, title: "Piscina Aquecida", description: "Piscina climatizada com vista para as montanhas, deck exclusivo e passarela até o lago. Diferentes profundidades — da principal de 1,5m ao espaço infantil de 60cm.", image: "https://www.minhagloria.com.br/lovable-uploads/f5b7fb42-f922-4170-a409-e216226108dd.png", audience: "Todos" },
  { icon: Gamepad2, title: "Sala de Jogos", description: "Sinuca, ping-pong, jogos de cartas e TV por satélite. Um universo de entretenimento para todas as gerações em ambiente acolhedor.", image: "https://www.minhagloria.com.br/lovable-uploads/0114d434-8ce2-46f6-8993-fbc616165aa6.png", audience: "Todos" },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-20">
        ...
        {/* Animals Section */}
        <section className="py-24 lg:py-32 bg-hotel-cream overflow-hidden">
          <div className="container mx-auto px-4">
            <motion.div
            ...
            >
              <div className="w-20 h-20 mx-auto mb-8 rounded-full bg-secondary/20 flex items-center justify-center">
                <Bird className="text-secondary" size={36} />
              </div>
              <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground font-semibold mb-6 leading-[1.05]">
                Um mundo de <span className="italic text-secondary">encanto</span> animal
              </h2>
              <p className="text-editorial text-muted-foreground text-xl leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <Bird className="text-secondary" size={22} />
                  <h3 className="font-display text-2xl font-semibold text-foreground">Aves Exóticas</h3>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  {aves.map((animal, i) => (
                    <span key={i} className="text-muted-foreground font-body text-sm py-1.5 border-b border-border/50 last:border-0">
                      {animal.name}
                    </span>
                  ))}
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <Dog className="text-secondary" size={22} />
                  <h3 className="font-display text-2xl font-semibold text-foreground">Fazenda & Companhia</h3>
                </div>
                <div className="grid grid-cols-2 gap-2">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-center text-muted-foreground/70 font-body text-sm mt-8 max-w-xl mx-auto"
            >
              Cada encontro com os animais é uma oportunidade de aprendizado e encantamento. 
              Experiências autênticas onde compartilhamos histórias e curiosidades sobre cada espécie.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-24 lg:py-32 bg-background">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto mb-24">
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground font-body text-lg leading-relaxed mb-4">
                  ...
                  Ingredientes puros da natureza combinam-se em rituais terapêuticos únicos, conduzindo 
                  corpo e mente a um estado de harmonia plena.
                </p>
                <p className="text-muted-foreground font-body text-lg leading-relaxed">
                  Massagens ao ar livre com vista para as montanhas, sauna seca e tratamentos com óleos 
                  essenciais e produtos naturais da serra — uma jornada sensorial que transcende o cotidiano.
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:order-2 overflow-hidden rounded-xl">
                <img
                  src="https://www.minhagloria.com.br/lovable-uploads/6b186013-a661-41cf-9044-a0f6888ba06f.png"
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:order-1">
                ...
                <p className="text-muted-foreground font-body text-lg leading-relaxed mb-4">
                  ...
                  e uma motocicleta by side — cada peça estrategicamente posicionada cria cenários perfeitos 
                  para fotografias memoráveis.
                </p>
                <p className="text-muted-foreground font-body text-lg leading-relaxed">
                  Tesouros do passado que agregam charme nostálgico à sua experiência e criam registros 
                  únicos da sua estada conosco.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-editorial text-primary-foreground/70 text-xl max-w-2xl mx-auto leading-relaxed">
                ...
                entre animais, sob as árvores, com os pés descalços. Monitores especializados guiam 
                atividades que conectam os pequenos à natureza enquanto os pais descansam.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
              ...
              >
                ...
                <p className="text-primary-foreground font-body text-base leading-relaxed">
                  Crianças até 6 anos se hospedam <strong className="text-secondary">gratuitamente</strong>
                </p>
              </motion.div>
            </div>
          </div>
