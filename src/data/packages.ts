...
const packages: HotelPackage[] = [
  ...
  },
  {
    ...
    pricePerNight: "R$ 1.134,00",
    priceNote: "em até 10x de R$ 226,80 sem juros",
    description: "Novidade! O Arraiá de Inverno foi estendido — agora acontece em todos os finais de semana de 19/06 a 25/07. O frio da serra transforma o Glória Hotel Boutique no cenário ideal para viver o charme das festas juninas com conforto, boa mesa e acolhimento.",
    longDescription: "Por aclamação dos nossos hóspedes, o Arraiá de Inverno ganhou edição estendida em 2026: além dos finais de semana de junho, vamos celebrar também em todos os finais de semana de julho — de 19/06 a 25/07. O frio da serra transforma o Glória Hotel Boutique no cenário ideal para viver o charme das festas juninas com conforto, boa mesa e acolhimento. Convidamos você e sua família para uma Programação Junina de Inverno, pensada para unir tradição, gastronomia e tranquilidade, em um ambiente intimista e cuidadosamente preparado. Aqui, o São João é celebrado em versão boutique: sem excessos, no ritmo certo, valorizando o prazer de estar junto.",
