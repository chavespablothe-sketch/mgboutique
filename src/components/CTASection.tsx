...
const CTASection = ({
  ...
  subtitle = "Apenas 20 suítes em meio à Mata Atlântica. Pensão completa, 1 criança até 06 anos grátis nos fins de semana e parcelamento em até 10x sem juros. Reserve a experiência perfeita para sua família.",
